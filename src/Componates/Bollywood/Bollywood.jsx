...
const result = data.filter((value) => value.category === "Bollywood");
console.log(result);

 
 console.log(result);
 const navigate=useNavigate()
  const handleMovie =(id,name,)=>{
...
return (
 <div onClick={()=>handleMovie(val._id,val.title)} key={index} className="card h-[65vh] w-[30vh] flex flex-col mx-6 my-5 ">
